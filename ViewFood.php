* This part of code works in admin portal, where the admin can view the food.
Admin is the head, who can have access to all the services.
When admin hover over the food, admin get the option of the view food
When admin select the option view food, admin can see the food
with image of the food item, the name of the item, the price of the food item.
Admin also have a option to add/delete the food item.
 */
        ...
        ?>
          ...
          <div class="card-body">
            ...
            <div class="card-footer bg-transparent border-dark">
                ...
                <a href="deletefood.php?id=<?php echo $row['fid']; ?>" class="btn btn-danger">delete</a>
            </center>
            </div>
          </div>
        </div>
