      ...
      <div class="section-title">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 col-md-12 form-group">
            <input type="text" name="cname" class="form-control" value="<?php echo $_SESSION['uname'] ?>" id="name" placeholder="Customer Name" readonly>
            <div class="validate"></div>
          </div>
          
          &nbsp;&nbsp;&nbsp;Feedback Message:
          <div class="col-lg-12 col-md-12 form-group">
           <textarea name="feed" id="" class="form-control" cols="45" rows="5" required></textarea>
          </div>
          
        <div class="text-center"><button name="Add" type="submit">Add Feedback</button></div>
    </div>
    </div>
    </div>
