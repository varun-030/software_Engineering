...
<body>
  ...
  /* Connect to the session of a customer with their username and display the payment records made by that customer, along with details such as the Bid, Days, Price per day, Coupon Code if applied, Discount Amount, Total Amount, Card Number, User name, and payment date. */
